...
<template lang="pug">
  keep-alive
    kalix-table(bizKey="hardwareconfigure" title='系统配置列表' v-bind:tableFields="tableFields" v-bind:targetURL="targetURL"
...
<script type="text/ecmascript-6">
  import {configAdminURL,  ConfigToolbarList} from '../../config.toml'

  export default {
    name: 'kalix-admin-config',
    data() {
      return {
