  ...
  div(style="height:100%")
    el-row.function-row(:gutter="0" style="height:100%;display:flex;align-items:center;")
      el-col.function-col(:span="10" style="position:relative;height:100%;")
        keep-alive
          kalix-table(bizKey="template" title="模板列表" v-bind:targetURL="templateURL"
      ...
      el-col.function-col(:span="14" style="height:100%;padding: 20px 0 0;box-sizing: border-box;")
        div(style="position:relative;height: 50%;padding-left:0px;")
          keep-alive
            kalix-table(bizKey="templateConfig" title="模板属性列表" v-bind:targetURL="templateConfigURL"
        ...
        div(style="position:relative;height: 50%;padding-left:0px;")
          keep-alive
            kalix-table(bizKey="templateContent" title="模板内容列表" v-bind:targetURL="templateContentURL"
...
<script type="text/ecmascript-6">
  import {templateURL, templateConfigURL, templateContentURL} from '../../config.toml'
  import {templateBtnList} from './config'
  import {configBtnList} from './indexConfig'
  import {contentBtnList} from './indexContent'

  export default {
    name:'kalix-admin-template',
    data() {
      return {
